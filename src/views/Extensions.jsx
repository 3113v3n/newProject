...
function Extensions(props) {
  ...
  const [values, setValues] = useState({
    extensionValues: [
      { name: "lossOfUse", value: 0, id: 1 },
      { name: "excessProtector", value: 0, id: 2 },
      { name: "AAMembership", value: 0, id: 3 },
      { name: "violence", value: 0, id: 4 },
      { name: "forcedATM", value: 0, id: 5 },
      { name: "personalAccident", value: 0, id: 6 },
      { name: "stationAccommodation", value: 0, id: 7 },
      { name: "lossOfPersonalEffect", value: 0, id: 8 }
    ]
  });
